...
"use strict";
throw new Error("Module build failed: SyntaxError: C:/Users/Asus/Desktop/tymczas/js/heroCreator.js: Unexpected token (825:2)\n\n  823 | \n  824 | \t\t\t$(\"#stick, #moneyBag, #travelBag, #purse, #backpack, #canteen, #pot, #blanket, #tubePartschmen, #penWriting, #parchments5pieces, #ordinaryClothing, #fussyHat, #coat, #leatherBelt, #needlesThread, #saddleCloth, #tent, #woodenBowl, #torch, #oliveLamp, #oilLamp, #rope5m, #tinders\").addClass(\"basicBtn btnNewGame medievalText width20 marginTop1 marginLeft5\");\n> 825 | \t});//koniec tworzenia ekwipunku\n      | \t ^\n  826 | \n  827 | \n  828 | //0-imię, 1-płeć, 2-rasa, 3-profesja, 4-siła, 5-wytrzymałość, 6-zręczność, 7-inteligencja, 8-charyzma, 9-kolor oczu, 10-kolor włosów, 11-kolor skóry, 12 - waga, 13-wzrost\n");
