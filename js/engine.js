	...
	$("#newGame").on("click", function () {
		...
		$("#features").on("click", function () {
			...
			$("#strength").on("click", function () {
				...
				if (randomFeatures.length < 5) {
					$("#feautresAlert").addClass("redText");
		...
		$("#features2").on("click", function () {
			...
			$("#features2MainWomen").on("click", function () {
			...
			$("#features2MainMen").on("click", function () {
			...
			$("#features2MainOther").on("click", function () {
			...
			$("#features2MainBlond").on("click", function () {
			...
			$("#features2MainRed").on("click", function () {
			...
			$("#features2MainBlack").on("click", function () {
			...
			$("#features2MainDyed").on("click", function () {
			...
			$("#features2MainHazel").on("click", function () {
				choosenFeatures.splice(2, 1, "piwne");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainGrey").on("click", function () {
				choosenFeatures.splice(2, 1, "szare");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainBrown").on("click", function () {
				choosenFeatures.splice(2, 1, "brązowe");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainBlue").on("click", function () {
				choosenFeatures.splice(2, 1, "niebieskie");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainWhite").on("click", function () {
				choosenFeatures.splice(3, 1, "biała");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainBrownSkin").on("click", function () {
				choosenFeatures.splice(3, 1, "brązowa");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainBlack").on("click", function () {
				choosenFeatures.splice(3, 1, "czarna");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainRed").on("click", function () {
				choosenFeatures.splice(3, 1, "czerwona");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainYellow").on("click", function () {
				choosenFeatures.splice(3, 1, "żółta");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainGreen").on("click", function () {
				choosenFeatures.splice(3, 1, "zielona");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainTawny").on("click", function () {
				choosenFeatures.splice(3, 1, "brunatna");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainAzure").on("click", function () {
				choosenFeatures.splice(3, 1, "błękitna");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainUnderweight").on("click", function () {
				choosenFeatures.splice(4, 1, "niedowaga");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainNormalweight").on("click", function () {
				choosenFeatures.splice(4, 1, "normalna");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainOverweight").on("click", function () {
				choosenFeatures.splice(4, 1, "nadwaga");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainShort").on("click", function () {
				choosenFeatures.splice(5, 1, "niski");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainNormalGrowth").on("click", function () {
				choosenFeatures.splice(5, 1, "normalny");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
			...
			$("#features2MainTall").on("click", function () {
				choosenFeatures.splice(5, 1, "wysoki");
				if (choosenFeatures.length < 6) {
					$("#features2Alert").addClass("redText");
				} else if (choosenFeatures.length == 6) {
					$("#features2Alert").addClass("greenText");
